...
def guard(message: str) -> tuple[bool, str | None]:
    ...
    with logfire.span("🛡️ Guardrails Check"):
        ...
        # Normalize unicode apostrophes (e.g. ’ / \u2019) for reliable substring matching
        normalized_content = content.replace(chr(8217), "'").replace("’", "'")

        fired = any(indicator in normalized_content for indicator in RAIL_INDICATORS)
