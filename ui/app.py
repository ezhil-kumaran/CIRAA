...
# --- SIDEBAR ---
with st.sidebar:
    st.title("🛡️ CloudSec IR Agent OS")
    st.markdown("---")
...
# --- MAIN CHAT ---
st.title("🛡️ CloudSec IR Agent — Cloud Security & Incident Investigator")
...
# Chat Input
if prompt := st.chat_input("Ask about cloud security incidents, NIST SP 800-61, AWS SIR, or log analysis..."):
